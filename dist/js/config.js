...
require.config({
  ...
  paths: {
		//plugins
		text: ['//cdnjs.cloudflare.com/ajax/libs/require-text/2.0.3/text.min', "../libs/requirejs-text/text"],

		// Core Libraries
		jquery: ["//cdnjs.cloudflare.com/ajax/libs/jquery/1.10.2/jquery.min","../libs/jquery/jquery.min"],
		underscore: ["//cdnjs.cloudflare.com/ajax/libs/lodash.js/2.1.0/lodash.min","../libs/lodash/dist/lodash.min"],
