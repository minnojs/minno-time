define(['pipAPI','underscore'], function(APIConstructor, _) {
	...
	/**
	 * Test for the measured delay between display and response
	 *
	 * click space to begin test, delay for some time and click enter.
	 * Make sure the measured latency fits the delay you made.
	 */
			...
			data: [
				{
					...
					interactions: [
						...
						// end trial (called after enter-click)
						{
